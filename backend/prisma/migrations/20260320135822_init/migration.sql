-- CreateEnum
CREATE TYPE "Role" AS ENUM ('ADMIN', 'EDITOR', 'WRITER', 'VIEWER');
...
-- CreateIndex
CREATE UNIQUE INDEX "PostView_postId_ipHash_viewedAt_key" ON "PostView"("postId", "ipHash", "viewedAt");
...
-- AddForeignKey
ALTER TABLE "AffiliateLink" ADD CONSTRAINT "AffiliateLink_postId_fkey" FOREIGN KEY ("postId") REFERENCES "Post"("id") ON DELETE SET NULL ON UPDATE CASCADE;
